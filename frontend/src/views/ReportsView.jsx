  ...
  return (
    <div className="view-stack">
      <div className="toolbar">
        <PageHeader title="Análises e Indicadores Operacionais" />
      </div>

      <section className="metric-grid reports-metric-grid">
        <StatCard label="Presenças" value={operational.attended || 0} tone="success" />
      ...
      <section className="split-layout reports-grid">
        <div className="data-card">
          <h3>Métricas Operacionais Absolutas</h3>
          <div className="report-summary">
            <p><strong>Total de Atendimentos Históricos:</strong> {operational.totalAppointments || 0} sessões</p>
            <ProgressRow label={`Presenças (${operational.attended || 0})`} value={operational.attendedPercentage} tone="success" />
        ...
        <div className="data-card">
          ...
          <div className="report-summary">
            ...
            <ProgressRow label="Adimplência" value={financial.paidPercentage} tone="success" />
            <ProgressRow label="Inadimplência" value={financial.openPercentage} tone="danger" />
          </div>
        </div>
      </section>
    </div>
